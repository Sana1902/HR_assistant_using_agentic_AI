    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-6">
      <div className="mx-auto max-w-5xl space-y-6">
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
          <Card className="border border-slate-700/70 bg-slate-800/40 backdrop-blur-xl">
            <CardHeader>
            ...
            <CardContent className="space-y-4">
              <label className="flex items-center justify-between gap-6 rounded-lg border border-slate-700/70 bg-slate-900/40 px-4 py-3">
                <div>
                    ...
                    <button
                      ...
                      className={`rounded-lg border px-3 py-2 text-sm capitalize transition ${
                        settings.weeklyDigestFrequency === option
                          ...
                          : 'border-slate-700/60 bg-slate-900/40 text-slate-300 hover:border-purple-500/30 hover:text-white'
                      }`}
                    >
                      {option}
                    </button>
          ...
          <Card className="border border-slate-700/70 bg-slate-800/40 backdrop-blur-xl">
            ...
            <CardContent className="space-y-4">
              ...
              <label className="space-y-1">
                <span className="text-xs uppercase tracking-wide text-slate-400">Timezone</span>
                <select
              ...
              <p className="rounded-lg border border-slate-700/70 bg-slate-900/30 px-3 py-2 text-xs text-slate-400">
                Local time in selected timezone: <span className="text-slate-200">{timezoneLabel}</span>
              </p>
            </CardContent>
          </Card>

          <Card className="lg:col-span-2 border border-slate-700/70 bg-slate-800/40 backdrop-blur-xl">
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-white">
            ...
            <CardContent className="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    <button
                      ...
                      className={`flex-1 rounded-lg border px-3 py-2 text-sm capitalize transition ${
                        settings.theme === option
                          ? 'border-purple-500/50 bg-purple-500/10 text-purple-200'
                          : 'border-slate-700/60 bg-slate-900/30 text-slate-300 hover:border-purple-500/30 hover:text-white'
                      }`}
                    >
                      {option}
                    </button>
              ...
              <div className="space-y-3">
                <label className="space-y-1">
                  <span className="text-sm font-medium text-white">Data export email</span>
                  <Input
                    type="email"
              ...
              <div className="md:col-span-2 rounded-lg border border-purple-500/20 bg-purple-500/5 px-4 py-3 text-xs text-purple-100 flex items-start gap-3">
